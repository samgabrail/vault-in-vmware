...
# Create and manage ACL policies - comprehensive approach
path "sys/policies/*" {
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
...
# List existing ACL policies specifically
path "sys/policies/acl" {
  capabilities = ["list"]
}

# Create and manage ACL policies specifically
path "sys/policies/acl/*" {
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
...
# Prevent admin users from reading user secrets in KV
path "kv/data/users/*" {
...
# Operations path from second policy
path "operations/*" {
  capabilities = ["create", "read", "update", "delete", "list"]
}

# Developers path from second policy
path "developers/*" {
  capabilities = ["create", "read", "update", "delete", "list"]
}
